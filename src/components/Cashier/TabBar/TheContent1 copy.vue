...
const handleItemClick = (e: any) => {
  ...
  if (/\d/g.test(dataItem)) emit('item-click-event', dataItem);
...
<template>
  <div class="list" @click="handleItemClick">
    <template v-for="{ goodsCode, name, price } in datalist">
      <div class="list-item test-class" :data-item="goodsCode">
